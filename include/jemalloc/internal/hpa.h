...
size_t hpa_try_purge_then_hugify(tsdn_t *tsdn, hpa_shard_t *shard,
				 size_t ntarget);
size_t hpa_try_hugify_all(tsdn_t *tsdn, hpa_shard_t *shard);
bool hpa_purge_analytics_read(tsdn_t *tsdn, hpa_shard_t *shard,
			      bool trylock, size_t *npending_purge,
			      psset_stats_t *stats, fb_group_t *purge_bitmap,
			      bool *blocked_by_dirty);
